<?php 
    ...
    $report_list = array();
    $report_list = $obj->GetSalesTaxReportList($from_date, $to_date, $party_id);

    $excel_name = "";
    $excel_name = "Sales Tax Report (".date('d-m-Y',strtotime($from_date))." to ".date('d-m-Y',strtotime($to_date)).")";
?>
    ...
    <div class="main-content">
        <div class="page-content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <form name="sales_tax_report_form" method="post">
                            ...
                            <div class="border card-box" id="table_records_cover">
                                ...
                                <div class="row">
                                    <div class="table-responsive">
                                         <table class="table table-nowrap table-bordered nowrap text-center table-hover" id="tbl_sales_tax_report">
                                            <thead style="background-color:#333;color:white">
                                                <tr>
                                                    <th colspan="20" class="text-center" style="border: 1px solid #dee2e6;font-weight: bold; font-size: 18px;">
                                                        Sales Tax Report <?php if(!empty($from_date)){ echo " (" .date('d-m-Y',strtotime($from_date )) ." to ". date('d-m-Y',strtotime($to_date)).")"; }?>
                                                    </th>
                                                </tr>
...
<script type="text/javascript">
    function getOverallReport(){
        if(jQuery('form[name="sales_tax_report_form"]').length > 0){
            jQuery('form[name="sales_tax_report_form"]').submit();
        }
    }
</script>
<script>
    function ExportToExcel(type, fn, dl) {
        ...
        var elt = document.getElementById('tbl_sales_tax_report');
