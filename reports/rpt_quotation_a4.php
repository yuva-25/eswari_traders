<?php
    ...
    if (isset($_REQUEST['view_quotation_id'])) {
        $view_quotation_id = $_REQUEST['view_quotation_id'];
    }else {
        header("Location: ../quotation.php");
        exit;
    }  

    $quotation_date = date('d-m-Y'); $bill_number = ""; $party_id = ""; $godown_type = "";  $product_count = 0; $gst_option = 2; $tax_option = 1;$tax_type = 2;$party_state = ""; $company_state = "";
    ...
    if(!empty($view_quotation_id)){
        ...
        $pdf->SetY($bill_to_y);
        $pdf->SetX(113);
        $pdf->Cell(80,8,'Quotation No.              :  ',0,0,'L',0);

        $pdf->SetFont('Arial','',9);
        $pdf->SetX(153);
        $pdf->Cell(40,8,$quotation_number,0,1,'L',0);
        ...
        $pdf->SetFont('Arial','',9);
        $pdf->SetX(153);
        $pdf->Cell(40,8,date('d-m-Y',strtotime($quotation_date)),0,1,'L',0);
        $bill_to_y2 = $pdf->GetY();
        ...
        if(!empty($view_quotation_id) && !empty($product_ids)) { 
