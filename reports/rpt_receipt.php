<?php
    ...
    $receipt_number = ""; $receipt_date = ""; $party_id = ""; $party_name = "";$narration = ""; $amounts = array(); $payment_mode_names = array(); $bank_names = array(); $total_amount = 0; $deleted = 0; $company_id = "";
    ...
    if(!empty($receipt_list)) {
        foreach($receipt_list as $data) {
            ...
            $receipt_number = !empty($data['receipt_number']) ? $data['receipt_number'] : "";
            $receipt_date = (!empty($data['receipt_date']) && $data['receipt_date'] != "0000-00-00") ? date('d-m-Y', strtotime($data['receipt_date'])) : "";
