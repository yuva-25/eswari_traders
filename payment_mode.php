                        ...
                        <div class="card">
                            ...
                            <div class="border card-box" id="table_records_cover">
                                    ...
                                    <div class="row justify-content-end p-2">
                                        <div class="col-lg-3 col-md-4 col-8">
                                            <div class="input-group">
                                                <input type="text" class="form-control" style="height:34px;" name="search_text" placeholder="Search By Name" aria-label="Search" aria-describedby="basic-addon2">
                                ...
                                <div id="table_listing_records">
                                    <input type="hidden" name="page_title" value="<?php if(!empty($page_title)) { echo $page_title; } ?>">
                                    <?php
                                    $view_access_error = ""; $permission_module = $GLOBALS['payment_mode_module']; $permission_action = $view_action;
                                    if(!empty($login_staff_id)) {
                                          include('permission_action.php');
                                    }
                                    if(empty($view_access_error)) { ?>
                                       <?php include("payment_mode_table.php"); ?>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>   
...
<script>
    $(document).ready(function(){
        ...
        var changes_file = "payment_mode_changes.php";
        var tableId = "payment_mode_table";
        var processing = true;
        var ordering = true;
        var searching = false;
        var orderable = false;
        ...
        var columns = [
            ...
            { "data": "payment_mode_name", "className": "text-center" },
