<?php 
    ...
    $total_records_list = $obj->getPurchaseBillReport($GLOBALS['bill_company_id'],$filter_party_id,$from_date, $to_date,$cancel_bill_btn);
                                ...
                                <div class="card-header align-items-center">
                                    <div class="row  p-2">   
                                        ...
                                        <div class="col-lg-3 col-md-4 col-12 text-end">
                                                <button class="btn btn-success m-1 float-end" style="font-size:11px;" type="button" onClick="window.open('reports/rpt_purchase_report_a4.php?filter_party_id=<?php echo $filter_party_id; ?>&from_date=<?php echo $from_date; ?>&to_date=<?php echo $to_date; ?>&cancel_bill_btn=<?php echo $cancel_bill_btn; ?>')"> <i class="fa fa-print"></i> Print </button>
...
<script type="text/javascript">
    function getOverallReport() {
        var from_date = ""; var to_date = ""; var party_id = ""; var cancel_bill_btn = "";
