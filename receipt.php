                    ...
                    <div class="card">
                        ...
                        <div class="border card-box" id="table_records_cover">
                            <div class="card-header align-items-center">
                                <div class="row justify-content-end p-2">   
                                    ...
                                    <div class="col-lg-1 col-md-2 col-6 text-end">
                                                   <?php 
                                        $add_access_error = ""; $permission_module = $GLOBALS['receipt_module']; $permission_action = $add_action;
                            ...
                            <div id="table_listing_records">
                                <?php 
                                $view_access_error = ""; $permission_module = $GLOBALS['receipt_module']; $permission_action = $view_action;
                                if(!empty($login_role_id)) {
                                    include("permission_action.php");
                                }
                                    ...
                                    <div class="new">
                                        <ul class="new nav nav-pills my-3 justify-content-center" id="pills-tab" role="tablist">
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link active" id="pills-active-tab" data-bs-toggle="pill" data-bs-target="#pills-active" type="button" role="tab" aria-controls="pills-active" aria-selected="true">Active Receipt</button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link" id="pills-cancel-tab" data-bs-toggle="pill" data-bs-target="#pills-cancel" type="button" role="tab" aria-controls="pills-cancel" aria-selected="false">Cancelled Receipt</button>
                                            </li>
                                        </ul>
...
<script>
    jQuery(document).ready(function(){
        ...
        var columns = [
            ...
            { "data": "receipt_number", "className": "text-center" },
