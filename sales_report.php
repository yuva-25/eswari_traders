<?php 
    ...
    $total_records_list = $obj->getSalesBillReport($GLOBALS['bill_company_id'],$filter_party_id,$from_date, $to_date,$filter_bill_type,$cancel_bill_btn);
    ...
    <div class="main-content">
        <div class="page-content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <form name="sales_report_form" method="post">
                                ...
                                <div class="card-header align-items-center">
                                    <div class="row  p-2">   
                                        ...
                                        <div class="col-lg-2 col-md-4 col-6">
                                            <div class="form-group mb-2">
                                                <div class="form-label-group in-border mb-0">
                                                    <select class="select2 select2-danger" name="bill_type" data-dropdown-css-class="select2-danger"  style="width: 100%;" onchange="Javascript:getOverallReport();">
                                        ...
                                        <div class="col-lg-2 col-md-4 col-12 text-end">
                                                <button class="btn btn-success m-1 float-end" style="font-size:11px;" type="button" onClick="window.open('reports/rpt_sales_report_a4.php?filter_party_id=<?php echo $filter_party_id; ?>&from_date=<?php echo $from_date; ?>&to_date=<?php echo $to_date; ?>&view_type=<?php echo $filter_bill_type; ?>&cancel_bill_btn=<?php echo $cancel_bill_btn; ?>')"> <i class="fa fa-print"></i> Print </button>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered nowrap cursor text-center smallfnt" id="tbl_sales_list">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <?php
                                                    $grand_amount = 0; $total_amount=0;$total_quantity =0;
...
<script type="text/javascript">
    function getOverallReport() {
        ...
        if(jQuery('select[name="view_type"]').length > 0) {
            view_type = jQuery('select[name="view_type"]').val();
        }
        ...
        if(jQuery('form[name="sales_report_form"]').length > 0){
            jQuery('form[name="sales_report_form"]').submit();
        }
