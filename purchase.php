                    ...
                    <div class="card">
                        ...
                        <div class="border card-box" id="table_records_cover">
                            <div class="card-header align-items-center">
                                <div class="row justify-content-end p-2">   
                                    ...
                                    <div class="col-lg-1 col-md-2 col-6 text-end">
                                                   <?php 
                                        $add_access_error = ""; $permission_module = $GLOBALS['purchase_module']; $permission_action = $add_action;
                            ...
                            <div id="table_listing_records">
                                <?php 
                                $view_access_error = ""; $permission_module = $GLOBALS['purchase_module']; $permission_action = $view_action;
                                if(!empty($login_role_id)) {
                                    include("permission_action.php");
                                }
...
<script>
    jQuery(document).ready(function(){
        ...
        var changes_file = "purchase_changes.php";
        var processing = true;
        var ordering = true;
        var searching = false;
        var orderable = false;
