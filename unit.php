                        ...
                        <div class="card">
                            ...
                            <div class="border card-box" id="table_records_cover">
                                ...
                                <div id="table_listing_records">
                                    ...
                                    <?php
                                    $view_access_error = ""; $permission_module = $GLOBALS['unit_module']; $permission_action = $view_action;
                                    if(!empty($login_staff_id)) {
                                          include('permission_action.php');
                                    }
                                    if(empty($view_access_error)) { ?>
                                       <?php include("unit_table.php"); ?>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>   
...
<script>
    $(document).ready(function(){
        ...
        var changes_file = "unit_changes.php";
        var tableId = "unit_table";
        var processing = true;
        var ordering = true;
        var searching = false;
        var orderable = false;
